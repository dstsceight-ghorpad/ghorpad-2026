...
const _rawPersonnel: Personnel[] = [
  ...
  // ── ARJAN DIVISION ──
  ...buildSO("Arjan", "arj", [
    ["Ananya Pandey", "Wg Cdr", "AE (L)"],
    ["Manmeet Singh Narang", "Wg Cdr", "F(P)"],
    ["Chetan Raut", "Wg Cdr", "F(P)"],
    ["SK Sharma", "Wg Cdr", "AE (M)"],
    ["Anshuman Rai", "Lt Col", "ASC"],
    ["Shardendu Pandey", "Cdr", "Logistics"],
    ["Chinthu K V", "Wg Cdr", "AE (L)"],
    ["Phani Sushant", "Cdr", "Executive Branch"],
    ["Rishabh Rawat", "Lt Col", "Infantry"],
    ["Shivam Trivedi", "Wg Cdr", "Logistics"],
    ["Sreejesh N", "Cdr", "Engineering"],
    ["Gopikrishnan U", "Cdr", "Engineering"],
    ["Pravin Kumar Vinod Rai", "Wg Cdr", "F(N)"],
    ["Ashay Pal", "Lt Col", "Army Air Defence"],
    ["Dhar Anurag S", "Major", "Corps of Signals"],
    ["Anuj Kumar", "Major", "Infantry"],
    ["Awanendra Pratap Singh", "Major", "Corps of Engineers"],
    ["Sumit Singh Sidhu", "Sqn Ldr", "AE (M)"],
    ["Amit Kumar", "Major", "Army Ordnance Corps"],
    ["Nitish Sharma", "Sqn Ldr", "Administration"],
    ["Praneeth H Vishnu", "Major", "Army Air Defence"],
    ...
    ["Comdt (JG) Pankaj Ghungtyal", "Comdt (JG)", "Indian Coast Guard"],
    ["Haobam Rahul Singh", "Major", "Infantry"],
    ["Bhupesh Yadav", "Major", "Corps of Signals"],
    ["Ajatshtru Rampal", "Major", "Infantry"],
    ["Pillai Mithun", "Major", "Regiment of Artillery"],
    ["Pushpendra Singh", "Major", "Armoured Corps"],
    ["Alok Negi", "Major", "Infantry"],
    ["Ishank Sharma", "Major", "Regiment of Artillery"],
    ["Shashi Kumar", "Major", "Regiment of Artillery"],
    ["Arpit Kumar Upadhyay", "Major", "Mechanised Infantry"],
    ["Mukul", "Major", "Corps of Engineers"],
    ["Shakti Kumar Upadhyay", "Major", "Infantry"],
    ["Alebachew Etana Kusa", "Lt Col", "Ethiopian Army"],
    ["Kashun Bahiru Wolderufael", "Major", "Ethiopian Air Force"],
    ["GKDBJ Dissanayake", "Sqn Ldr", "Sri Lanka Air Force"],
    ["WGPCI Wijisekara", "Sqn Ldr", "Sri Lanka Air Force"],
  ]),
  ...
  ...buildSO("Pereira", "per", [
    ...
    ["Dhairya Kumar", "Major", "Infantry"],
    ["Ravindra Kumar", "Major", "Corps of Engineers"],
